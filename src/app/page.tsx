...
import { ArrowRight, Database, Dna, LockKeyhole, ServerCog } from 'lucide-react';
...
export default function Home() {
  return <div className="pb-16">
    <section className="reveal relative min-h-[650px] overflow-hidden py-16 sm:py-24">
      <div className="absolute right-[-110px] top-12 h-[520px] w-[520px] rounded-full border-[90px] border-[#dcecff]" />
