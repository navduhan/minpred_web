...
export default function ResultsPage(){
  ...
  return <div className="space-y-6 py-5 sm:py-8">
    <header className="border-l-4 border-[#42a5ff] bg-[var(--forest-dark)] px-6 py-8 text-white"><p className="flex items-center gap-2 text-[11px] font-black uppercase tracking-[.18em] text-[#84c5ff]"><CheckCircle2 className="h-4 w-4"/>Prediction complete</p><h1 className="mt-2 font-display text-4xl font-semibold">MINpred results</h1><p className="mt-2 text-sm text-slate-300">Review phase predictions, class probabilities, EC annotations, and protein structures.</p></header>
